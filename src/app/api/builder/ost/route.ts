...
### Level 2: Opportunities (2 per outcome = 2 nodes)
...
### Level 3: Solutions (2 per opportunity = 4 nodes)
...
### Level 4: Tests (1 per solution = 4 nodes)
...
MINIMUM 10 nodes total. Each title must be a detailed sentence, NOT a vague phrase.
Make sure parentId references are CONSISTENT — every child must reference a valid parent UUID.`,
      system: `You are an expert product strategist specializing in Opportunity Solution Trees. You create deep, interconnected trees where every node is specific enough to be actionable. Your outcome nodes have measurable KPIs. Your opportunity nodes cite specific user pain points. Your solution nodes describe concrete features. Your test nodes specify exact experiments with success criteria. You ALWAYS generate exactly the requested number of nodes with proper parent-child relationships using consistent UUIDs.`,
    });
