...
- 4-5 tasks focused on customer interviews, prototype testing, assumption validation
...
- 4-5 engineering tasks for the minimum viable product
...
- 4-5 tasks focused on first 10-50 customers, pricing validation, retention metrics
- Duration: 7-21 days per task
...
- 4-5 tasks focused on growth systems, partnerships, fundraising prep
